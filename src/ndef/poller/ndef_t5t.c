...
static ndefStatus ndefT5TWriteCC(ndefContext *ctx);
...
/*******************************************************************************/
ndefStatus ndefT5TPollerSetAccessMode(ndefT5TAccessMode mode)
{
    gAccessMode = mode;
...
#ifdef TEST_NDEF
/*******************************************************************************/
ndefStatus ndefT5TPollerMultipleBlockRead(ndefContext *ctx, bool enable)
{
...
/*******************************************************************************/
ndefStatus ndefT5TPollerContextInitialization(ndefContext *ctx, const ndefDevice *dev)
{
...
/*******************************************************************************/
ndefStatus ndefT5TPollerNdefDetect(ndefContext *ctx, ndefInfo *info)
{
    ndefStatus result;
...
/*******************************************************************************/
ndefStatus ndefT5TPollerReadRawMessage(ndefContext *ctx, uint8_t *buf, uint32_t bufLen, uint32_t *rcvdLen, bool single)
{
    ndefStatus result;
...
/*******************************************************************************/
ndefStatus ndefT5TPollerWriteRawMessageLen(ndefContext *ctx, uint32_t rawMessageLen, bool writeTerminator)
{
    uint8_t    TLV[8U];
    ndefStatus result;
    uint8_t    len;
    ...
    result = ndefT5TPollerWriteBytes(ctx, ctx->subCtx.t5t.TlvNDEFOffset + NDEF_T5T_TLV_T_LEN, TLV, len, writeTerminator && (rawMessageLen == 0U), false);

    return result;
}

/*******************************************************************************/
ndefStatus ndefT5TPollerWriteRawMessage(ndefContext *ctx, const uint8_t *buf, uint32_t bufLen)
{
    uint32_t   len = bufLen;
    ndefStatus result;
...
/*******************************************************************************/
ndefStatus ndefT5TPollerTagFormat(ndefContext *ctx, const ndefCapabilityContainer *cc, uint32_t options)
{
    ndefStatus               result;
...
/*******************************************************************************/
ndefStatus ndefT5TPollerCheckPresence(ndefContext *ctx)
{
    ndefStatus ret;
...
/*******************************************************************************/
ndefStatus ndefT5TPollerCheckAvailableSpace(const ndefContext *ctx, uint32_t messageLen)
{
    uint32_t lLen;
...
/*******************************************************************************/
ndefStatus ndefT5TPollerBeginWriteMessage(ndefContext *ctx, uint32_t messageLen)
{
    ndefStatus ret;
    uint32_t   lLen;
...
/*******************************************************************************/
ndefStatus ndefT5TPollerEndWriteMessage(ndefContext *ctx, uint32_t messageLen, bool writeTerminator)
{
    ndefStatus ret;
...
/*******************************************************************************/
ndefStatus ndefT5TPollerSetReadOnly(ndefContext *ctx)
{
    ndefStatus ret;
