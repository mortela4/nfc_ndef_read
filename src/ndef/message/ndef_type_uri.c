...
/*****************************************************************************/
static ndefStatus ndefRtdUriProtocolAutodetect(uint8_t* protocol, ndefConstBuffer* bufUriString)
{
    if ( (protocol  == NULL)                       ||
...
/*****************************************************************************/
ndefStatus ndefRtdUriInit(ndefType* uri, uint8_t protocol, const ndefConstBuffer* bufUriString)
{
...
/*****************************************************************************/
ndefStatus ndefGetRtdUri(const ndefType* uri, ndefConstBuffer* bufProtocol, ndefConstBuffer* bufUriString)
{
    const ndefTypeRtdUri* rtdUri;
...
/*****************************************************************************/
static ndefStatus ndefPayloadToRtdUri(const ndefConstBuffer* bufUri, ndefType* uri)
{
    uint8_t protocol;
...
/*****************************************************************************/
ndefStatus ndefRecordToRtdUri(const ndefRecord* record, ndefType* uri)
{
    const ndefType* type;
...
/*****************************************************************************/
ndefStatus ndefRtdUriToRecord(const ndefType* uri, ndefRecord* record)
{
    if ( (uri    == NULL) || (uri->id != NDEF_TYPE_ID_RTD_URI) ||
         (record == NULL) )
    {
