...
/*****************************************************************************/
ndefStatus ndefRtdWlcCapabilityInit(ndefType* type, const ndefTypeRtdWlcCapability* param)
{
...
/*****************************************************************************/
ndefStatus ndefGetRtdWlcCapability(const ndefType* type, ndefTypeRtdWlcCapability* param)
{
    const ndefTypeRtdWlcCapability* ndefData;
...
/*****************************************************************************/
static ndefStatus ndefPayloadToRtdWlcCapability(const ndefConstBuffer* bufPayload, ndefType* type)
{
    ndefTypeRtdWlcCapability* ndefData;
    ...
    /* WLC TS v2.0 11.1.1.1 Any additional bytes inside an NDEF Record defined in this specification SHALL be ignored by the receiver.*/
...
/*****************************************************************************/
ndefStatus ndefRecordToRtdWlcCapability(const ndefRecord* record, ndefType* type)
{
...
/*****************************************************************************/
ndefStatus ndefRtdWlcCapabilityToRecord(const ndefType* type, ndefRecord* record)
{
    if ( (type   == NULL) || (type->id != NDEF_TYPE_ID_RTD_WLCCAP) ||
         (record == NULL) )
    {
...
/*****************************************************************************/
ndefStatus ndefRtdWlcStatusInfoInit(ndefType* type, const ndefTypeRtdWlcStatusInfo* param)
{
...
/*****************************************************************************/
ndefStatus ndefGetRtdWlcStatusInfo(const ndefType* type, ndefTypeRtdWlcStatusInfo* param)
{
    const ndefTypeRtdWlcStatusInfo* ndefData;
...
/*****************************************************************************/
static ndefStatus ndefPayloadToRtdWlcStatusInfo(const ndefConstBuffer* bufPayload, ndefType* type)
{
    ndefTypeRtdWlcStatusInfo* ndefData;
...
/*****************************************************************************/
ndefStatus ndefRecordToRtdWlcStatusInfo(const ndefRecord* record, ndefType* type)
{
    const ndefType* ndefData;
...
/*****************************************************************************/
ndefStatus ndefRtdWlcStatusInfoToRecord(const ndefType* type, ndefRecord* record)
{
    if ( (type   == NULL) || (type->id != NDEF_TYPE_ID_RTD_WLCSTAI) ||
         (record == NULL) )
    {
...
/*****************************************************************************/
ndefStatus ndefRtdWlcPollInfoInit(ndefType* type, const ndefTypeRtdWlcPollInfo* param)
{
...
/*****************************************************************************/
ndefStatus ndefGetRtdWlcPollInfo(const ndefType* type, ndefTypeRtdWlcPollInfo* param)
{
    const ndefTypeRtdWlcPollInfo* ndefData;
...
/*****************************************************************************/
static ndefStatus ndefPayloadToRtdWlcPollInfo(const ndefConstBuffer* bufPayload, ndefType* type)
{
    ndefTypeRtdWlcPollInfo* ndefData;
...
/*****************************************************************************/
ndefStatus ndefRecordToRtdWlcPollInfo(const ndefRecord* record, ndefType* type)
{
    const ndefType* ndefData;
...
/*****************************************************************************/
ndefStatus ndefRtdWlcPollInfoToRecord(const ndefType* type, ndefRecord* record)
{
    if ( (type   == NULL) || ((type)->id != NDEF_TYPE_ID_RTD_WLCINFO) ||
         (record == NULL) )
    {
...
/*****************************************************************************/
ndefStatus ndefRtdWlcListenCtlInit(ndefType* type, const ndefTypeRtdWlcListenCtl* param)
{
...
/*****************************************************************************/
ndefStatus ndefGetRtdWlcListenCtl(const ndefType* type, ndefTypeRtdWlcListenCtl* param)
{
    const ndefTypeRtdWlcListenCtl* ndefData;
...
/*****************************************************************************/
static ndefStatus ndefPayloadToRtdWlcListenCtl(const ndefConstBuffer* bufPayload, ndefType* type)
{
    ndefTypeRtdWlcListenCtl* ndefData;
...
/*****************************************************************************/
ndefStatus ndefRecordToRtdWlcListenCtl(const ndefRecord* record, ndefType* type)
{
    const ndefType* ndefData;
...
/*****************************************************************************/
ndefStatus ndefRtdWlcListenCtlToRecord(const ndefType* type, ndefRecord* record)
{
    if ( (type   == NULL) || ((type)->id != NDEF_TYPE_ID_RTD_WLCCTL) ||
         (record == NULL) )
    {
