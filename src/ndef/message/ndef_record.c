...
/*****************************************************************************/
ndefStatus ndefRecordReset(ndefRecord* record)
{
...
/*****************************************************************************/
ndefStatus ndefRecordInit(ndefRecord* record, uint8_t tnf, const ndefConstBuffer8* bufType, const ndefConstBuffer8* bufId, const ndefConstBuffer* bufPayload)
{
    if (record == NULL)
    {
        return ERR_PARAM;
...
/*****************************************************************************/
ndefStatus ndefRecordSetType(ndefRecord* record, uint8_t tnf, const ndefConstBuffer8* bufType)
{
    if ( (record  == NULL) ||
...
/*****************************************************************************/
ndefStatus ndefRecordGetType(const ndefRecord* record, uint8_t* tnf, ndefConstBuffer8* bufType)
{
...
/*****************************************************************************/
ndefStatus ndefRecordSetId(ndefRecord* record, const ndefConstBuffer8* bufId)
{
    if ( (record == NULL) ||
...
/*****************************************************************************/
ndefStatus ndefRecordGetId(const ndefRecord* record, ndefConstBuffer8* bufId)
{
...
/*****************************************************************************/
ndefStatus ndefRecordSetPayload(ndefRecord* record, const ndefConstBuffer* bufPayload)
{
    if ( (record     == NULL) ||
...
/*****************************************************************************/
ndefStatus ndefRecordGetPayload(const ndefRecord* record, ndefConstBuffer* bufPayload)
{
...
/*****************************************************************************/
ndefStatus ndefRecordDecode(const ndefConstBuffer* bufPayload, ndefRecord* record)
{
    uint32_t offset;
...
/*****************************************************************************/
ndefStatus ndefRecordEncodeHeader(const ndefRecord* record, ndefBuffer* bufHeader)
{
    uint32_t offset;
...
/*****************************************************************************/
static ndefStatus ndefRecordEncodePayload(const ndefRecord* record, ndefBuffer* bufPayload)
{
    uint32_t payloadLength;
    uint32_t offset;
    bool     begin;
...
/*****************************************************************************/
ndefStatus ndefRecordEncode(const ndefRecord* record, ndefBuffer* bufRecord)
{
    ndefStatus err;
