...
/*****************************************************************************/
static ndefStatus ndefPayloadToRtdTnepServiceParameter(const ndefConstBuffer* bufTnepServiceParameter, ndefType* type)
{
    uint8_t tnepVersion;
...
/*****************************************************************************/
static ndefStatus ndefPayloadToRtdTnepServiceSelect(const ndefConstBuffer* bufTnepServiceSelect, ndefType* type)
{
    ndefConstBuffer bufServiceUri;
...
/*****************************************************************************/
static ndefStatus ndefPayloadToRtdTnepStatus(const ndefConstBuffer* bufTnepStatus, ndefType* type)
{
    uint8_t statusType;
